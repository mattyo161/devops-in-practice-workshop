...
kubectl apply -f kubernetes-glcoud/mysql.yml --namespace default
...
cat kubernetes-glcoud/web.yml | sed "s/\(image: \).*$/\1us.gcr.io\/$PROJECT_ID\/pet-app:$IMAGE_VERSION/" | kubectl apply -f - --namespace default
